...
const Hero = () => {
    ...
    return (
        <main >
            {/* lg:w-[900px] sm:w-fit */}
            {/* <div className="flex flex-row p-0 items-center md:px-8 lg:px-12 text-end" >
                <a className="" target="" href={"https://csu-physics.github.io/"} >
                    <FaArrowLeft size={35} className="w-[45px] h-[35px] " />
                </a>
                <h1 className="text-xl sm:text-2xl font-semibold" >Nuclear Binding Energy Calculator</h1>
            </div> */}

            <div className="max-w-[1640px] mx-auto flex justify-between items-center px-6 py-0 mt-0" >
                ...
                <div className={"flex-4"} >
                    <div className="bg-[#6f263d] text-white flex justify-between items-start h-[200px] w-[900px] mx-auto p-8 shadow-md hero my-4"></div>
                </div>
                <div className="flex-1 " ></div>

            </div>

            <div className=" flex flex-col items-center text-black bg-white text-lg mt-0 w-11/12 lg:w-full p-3 pt-0"  >
